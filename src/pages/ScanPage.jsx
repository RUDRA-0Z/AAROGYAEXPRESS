    ...
    return (
      <div style={{ background:"linear-gradient(180deg,#8aab5c 0%,#8aab5c 240px,#f5f2eb 240px)",minHeight:"100vh",paddingBottom:100,fontFamily:"'Nunito',system-ui,sans-serif" }}>
        ...
        <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",padding:"8px 4px 12px" }}>
          <button onClick={() => { setScanComplete(false); setScanData(null); setAddedToReminders(false); }} style={{ width:38,height:38,borderRadius:"50%",background:"rgba(255,255,255,0.22)",border:"none",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,color:"white" }}>←</button>
