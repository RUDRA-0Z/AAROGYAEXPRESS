...
export default function LoginPage() {
  ...
  return (
    <div className="login-wrapper">
      <style>{`
        .login-wrapper { font-family:'Nunito Sans',sans-serif;background:#f5f7f6;display:flex;justify-content:center;min-height:100vh;width:100%; }
        .login-wrapper * { box-sizing: border-box; margin: 0; padding: 0; }
        .phone{width:100%;max-width:560px;min-height:100vh;background:#f5f7f6;display:flex;flex-direction:column;position:relative}
        .header{background:var(--olive-dark);padding:24px 22px 20px;display:flex;justify-content:space-between;align-items:center}
        ...
        .hero-card{background:var(--olive);border-radius:8px;padding:24px 22px;position:relative;overflow:hidden;min-height:168px}
        ...
        .auth-card{background:#fff;border:1px solid #dde3e0;border-radius:6px;padding:16px 18px;display:flex;align-items:center;gap:14px;cursor:pointer;width:100%;text-align:left; transition:border-color 0.1s;}
        .auth-card:active{transform:scale(0.98)}
        .auth-icon{width:52px;height:52px;border-radius:6px;display:flex;align-items:center;justify-content:center;flex-shrink:0}
        .aig{background:#f0f4fe}
        .aie{background:#e8f5ef}
        ...
        .auth-arrow{width:32px;height:32px;background:#eef4ff;border-radius:6px;display:flex;align-items:center;justify-content:center;margin-left:auto;flex-shrink:0}

        /* DIVIDER */
        .divider{display:flex;align-items:center;gap:12px;padding:20px 18px 0}
        .div-line{flex:1;height:1px;background:#dde3e0}
        .div-txt{font-size:11px;color:#6b7280;font-weight:600;font-family:'Nunito Sans',sans-serif;white-space:nowrap}
        ...
        .field-wrap{display:flex;align-items:center;border:1px solid #dde3e0;border-radius:6px;padding:13px 16px;background:#fff;margin-bottom:12px}
        ...
        .cta-btn{width:100%;background:var(--olive);color:#fff;border:none;border-radius:6px;padding:15px;font-size:15px;font-weight:800;font-family:'Nunito',sans-serif;cursor:pointer;margin-top:4px;letter-spacing:0.2px}
      ...
      <div className="phone">
        <div className="scroll pt-8 flex flex-col">
          ...
          <div className="mt-auto pt-16 pb-6 flex flex-col items-center justify-center w-full text-center">
            <div className="w-12 h-0.75 bg-linear-to-r from-transparent via-[#8aab5c]/40 to-transparent rounded-full mb-5"></div>
