  ...
  return (
    <div className="login-wrapper">
      <style>{`
        ...
        .phone { width:100%;max-width:560px;min-height:100vh;background:#f5f7f6;display:flex;flex-direction:column;position:relative; overflow:hidden;}
        
        /* HEADER */
        .step-hdr { display:flex;justify-content:space-between;align-items:flex-end;padding:32px 22px 16px; background:var(--olive-dark); color:#fff; border-bottom:1px solid rgba(255,255,255,0.2); z-index:10; }
        ...
        .field-wrap { display:flex;align-items:center;border:1px solid #dde3e0;border-radius:6px;padding:14px 16px;background:#fff; transition:border-color 0.2s ease; }
        ...
        .pill { padding:14px; border-radius:6px; border:1px solid #dde3e0; background:#fff; font-size:14px; font-weight:800; color:var(--text-primary,#1b1c18); text-align:center; cursor:pointer; font-family:'Nunito',sans-serif; transition:all 0.2s;}
        ...
        .blood-pill { padding:16px 0; border-radius:6px; border:1px solid #dde3e0; background:#fff; font-size:16px; font-weight:900; color:var(--text-primary,#1b1c18); text-align:center; cursor:pointer; font-family:'Nunito',sans-serif; transition:all 0.2s;}
        ...
        .cta-btn { flex:1; height:56px; background:var(--olive);color:#fff;border:none;border-radius:6px;font-size:16px;font-weight:800;font-family:'Nunito',sans-serif;cursor:pointer;letter-spacing:0.2px; display:flex;justify-content:center;align-items:center;gap:8px; transition:all 0.2s;}
