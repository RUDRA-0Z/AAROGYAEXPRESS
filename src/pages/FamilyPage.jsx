...
/* ─── component helpers ────────────────────────────────────────────────────── */
const S = {
  card: { background:"#fff", borderRadius:6, padding:"16px 18px", border:"1px solid #dde3e0", marginBottom:12 },
  pill: (bg="#e8f5ef",color="#126a4d") => ({ background:bg, color, borderRadius:4, padding:"4px 12px", fontSize:11, fontWeight:800, display:"inline-block", fontFamily:"'Nunito',sans-serif" }),
  btn: (bg="#16805c",color="#fff") => ({
    background:bg, color, border:"none", borderRadius:4, padding:"11px 22px", fontSize:13,
    fontWeight:800, cursor:"pointer", fontFamily:"'Nunito',sans-serif", transition:"opacity .15s"
  }),
  input: { width:"100%", boxSizing:"border-box", background:"#fff", border:"1px solid #dde3e0", borderRadius:4, padding:"11px 14px", fontSize:14, fontWeight:600, fontFamily:"'Nunito',sans-serif", color:"#1f2937", outline:"none" },
  label: { fontSize:11, fontWeight:800, color:"#126a4d", textTransform:"uppercase", letterSpacing:.5, display:"block", marginBottom:6 },
}
...
export default function FamilyPage() {
  ...
  return (
    <div style={{ fontFamily:"'Nunito Sans',sans-serif", background:BG, minHeight:"100vh", paddingBottom:100 }}>
      ...
      {/* ── Hero banner ── */}
      <div style={{ background:"#16805c", margin:"0 0 0", padding:"24px 20px 28px", position:"relative", overflow:"hidden" }}>
