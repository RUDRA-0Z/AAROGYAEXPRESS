    ...
    return (
      <div style={{
        ...
        <button onClick={() => navigate("/")} style={{
          width: 38, height: 38, borderRadius: 6, border: "1px solid rgba(255,255,255,0.3)",
    ...
    return (
      <div style={{
        ...
        <button onClick={() => navigate(-1)} style={{
          width: 36, height: 36, borderRadius: 6, border: "1px solid rgba(255,255,255,0.3)",
          background: "transparent", cursor: "pointer",
          display: "flex", alignItems: "center", justifyContent: "center",
        ...
        <div style={{ position: "relative" }}>
          <select onChange={(e) => {
            ...
            padding: "6px 22px 6px 10px", borderRadius: 4, fontSize: 12,
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div style={{ position: "relative" }}>
          <select onChange={(e) => {
            ...
            background: "rgba(255,255,255,0.12)", color: "#fff", border: "1px solid rgba(255,255,255,0.25)",
            padding: "7px 26px 7px 12px", borderRadius: 4, fontSize: 13,
            fontWeight: 800, cursor: "pointer", fontFamily: "Nunito", appearance: "none", outline: "none",
          }}>
            <option style={{ color: "#000" }} value="en">A/अ</option>
            <option style={{ color: "#000" }} value="hi">हिंदी</option>
        ...
        {/* Chat icon */}
        <button style={{ width: 40, height: 40, borderRadius: 6, border: "1px solid rgba(255,255,255,0.25)", background: "transparent", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}>
        ...
        {user ? (
          <img
            ...
            style={{ width: 40, height: 40, borderRadius: 6, border: "2px solid rgba(255,255,255,0.8)", cursor: "pointer", objectFit: "cover" }}
          />
        ) : (
