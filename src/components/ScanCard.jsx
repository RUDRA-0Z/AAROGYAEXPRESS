...
export default function ScanCard() {
  ...
  const CARDS = [
    ...
    <div key="scan" style={{
      background: "linear-gradient(145deg,#1769aa,#0d4775)",
      borderRadius: 8, padding: "26px 24px 22px",
    ...
    <div key="sale" style={{
      ...
      <button onClick={() => navigate("/services", { state: { tab:"medicine", showSale:true } })} style={{
        background:"#fff", border:"none", borderRadius:4, padding:"11px 24px",
        fontSize:14, fontWeight:900, color:"#2563eb", fontFamily:"'Nunito',sans-serif",
